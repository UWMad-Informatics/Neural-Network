...
def loss_fn(predicted_value, true_value, l2_loss):
    return tf.reduce_mean(tf.square(predicted_value - true_value)) + 0.0001 * l2_loss
...
##            for i in predicted_value.get_shape()[0]:
##                print("*")
        l2_loss = loss
...
##            print(loss_value)
        ...
        # Saving the model
##        savepath_model = "/home/josh/Desktop/Informatics/standardized/modelSaves-effFluence"
##        path = saver.save(sess, os.path.join(savepath_model, "TensorFlow%s.ckpt"%seedNum))
